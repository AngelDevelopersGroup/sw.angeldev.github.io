<template>
	<article class="main">
		<div class="block-text block-text-first">
			...
			<p class="desc">Предложенный нами русификатор можно использовать в любое время, при любой погоде, с любой версией игры, но только для стим-клиента. Больше никакое обновление, никакой внезапный патч не сможет насмехаться над вашим языковым барьером! Обнови игру, переустанови патч и продолжай крабить!</p>
		</div>
